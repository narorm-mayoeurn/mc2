    ...
    <div class="container">
        <nav class="navbar navbar-default">
            <div class="navbar-header navbar-left">
                ...
                <h1><a class="navbar-brand" href="<c:url value="/" />">Resort <span>Inn</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <img src="<c:url value="/resource/images/1.jpg" />" alt=" " class="img-responsive">
...
<div class="about-wthree" id="about">
    <div class="container">
        <div class="ab-w3l-spa">
            ...
            <img src="<c:url value="/resource/images/about.jpg" />" class="img-responsive" alt="Hair Salon">
            <div class="w3l-slider-img">
                <img src="<c:url value="/resource/images/a1.jpg" />" class="img-responsive" alt="Hair Salon">
            </div>
    ...
    <div class="container">
        ...
        <div id="horizontalTab">
            <ul class="resp-tabs-list">
                <li>
                    <img src="<c:url value="/resource/images/teams1.jpg" />" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<c:url value="/resource/images/teams2.jpg" />" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<c:url value="/resource/images/teams3.jpg" />" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="<c:url value="/resource/images/teams4.jpg" />" alt=" " class="img-responsive" />
                </li>
            </ul>
...
<section class="portfolio-w3ls" id="gallery">
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value ="/resource/images/g1.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g1.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g2.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g2.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g3.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g3.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g4.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g4.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g5.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g5.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g6.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g6.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g6.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g7.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g6.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g8.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g9.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g9.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="<c:url value="/resource/images/g10.jpg" />" class="swipebox"><img src="<c:url value="/resource/images/g10.jpg" />" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
                ...
                <ul class="slides">
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="<c:url value="/resource/images/5.jpg" />" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="<c:url value="/resource/images/c1.jpg" />" alt=" " class="img-responsive" />
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="<c:url value="/resource/images/5.jpg" />" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="<c:url value="/resource/images/c2.jpg" />" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="<c:url value="/resource/images/5.jpg" />" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="<c:url value="/resource/images/c3.jpg" />" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="<c:url value="/resource/images/5.jpg" />" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="<c:url value="/resource/images/c4.jpg" />" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
